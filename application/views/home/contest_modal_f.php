	...
	if($(".upload-content").length > 0)
	{
		$('#contest-link').click(function (event)
		{
            ...
            $("#ste").animate({
            	...
            	$('#contest-link').removeClass('btn-warning');
	            ...
	            }, 1000, function()
	            {
	            	...
	            	$('#contest-link').text("VER GANADOR");
	            	$('#contest-link').removeClass('btn-info');
	            	$('#contest-link').addClass('btn-warning');
				});
	...
	<div class="responsive-bottom span7" id="info-contest" style="height:420px; position: relative !important;">
        ...
        <div class="upload-content photo-content">
	        ...
	        <div style="text-align:center;">
	        	...
	        	<div class="space05"></div>
	        	<div style="margin-left:20%; width:60%; font-size:21px; line-height: 40px; color: white; font-family: 'ganandofont'; background-color: #F1C40F">
	        		<?php echo $contest_winner["name"];?>
	        	</div>
	        </div>
    	</div>
	</div>
...
<div style="margin-right:2%;" class="row">
	<a id="contest-link" style="font-size:18px; line-height: 40px;" class="btn btn-warning pull-right"> VER GANADOR</a>
</div>
